          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
             ...
             <p className=' text-sm font-semibold px-6 py-2 text-grey-700'>Some error occurred... </p>
              ...
              <form class="space-y-4 md:space-y-6" action="#" onSubmit={handleSignup}>
                  <div>
                      <label for="displayName" class="block mb-2 text-sm font-medium text-gray-900">Username</label>
                      <input 
                      type="Username" 
                      name="Username" 
                      id="displayName" 
                      ...
                      className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Username" required/>
                  </div>
                  <div>
                  ...
                  <button type="submit" class="w-full text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Sign Up</button>
